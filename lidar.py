...
class Lidar(object):
    ...
    def connect(self):
        ...
        if self.__dev_TIM is None:
            raise ValueError("Please ensure that your TIM-Device is connected for autonomous driving")
    ...
    def scan(self):
        ...
        measured_data_contents = raw_data_arr[20]
        scaling_factor = parser.hex2float(raw_data_arr[21])
